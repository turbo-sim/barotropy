...
fluid.get_state(bpy.PT_INPUTS, p_in, T_in)


 
polytropic_efficiency = 1.00
calculation_type = "equilibrium"
q_onset = 1.0 # use the liquid line till quality of 5%
q_transition = 0.00 # transient from metastable liquid to equilibrium zone
