...
case_table = pd.read_excel("./simulation_cases.xlsx", sheet_name="SI Units")
# case_table = case_table[case_table["Test series"] == 1]
...
save_figures = True
colors = mpl.cm.Blues(np.linspace(0.2, 0.8, len(case_table)))  # Reds, Blues, magma
figs_axes = {}
plot_settings = [
    {
        "var_x": "p",
