...
props_stable = fluid.get_state(bpy.PT_INPUTS, 101325, 300)
print("\nProperties of liquid water")
print(props_stable)

# Properties of water/steam mixture
fluid = bpy.Fluid("Water", backend="HEOS")
props = fluid.get_state(bpy.QT_INPUTS, 0.5, 300)
print("\nProperties of water/steam mixture")
print(props)

# Get subset of properties for meanline code
props = fluid.compute_properties_meanline(bpy.QT_INPUTS, 0.5, 300)
print()
