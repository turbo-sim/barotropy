...
ax2.legend(loc="upper left", fontsize=10)
fig.tight_layout(pad=2)
bpy.savefig_in_formats(fig, os.path.join(fig_dir, "generalized_vapor_quality_isotherms"))
...
ax2.legend(loc="upper left", fontsize=10)
fig.tight_layout(pad=2)
bpy.savefig_in_formats(fig, os.path.join(fig_dir, "generalized_vapor_quality_isentropes"))
