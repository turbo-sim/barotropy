...
p_in = 1.25*p_critical;
s_frac_array = [0.6, 0.7, 0.8, 0.9, 0.95, 1.05, 1.1, 1.2, 1.3, 1.4, 1.5];
% s_frac_array = 0.98;
...
for j = 1:numel(s_frac_array)
    ...
    case_name = strrep(sprintf('results/%s_metastable_%0.0fScrit', fluid.fluid_name, 100*s_frac_array(j)), ".", "_");
...
% Save p-s diagram
if save_figures
    exportgraphics(fig, fullfile('results', sprintf('%s_ps_diagram_metastable.png', fluid_name)), Resolution=500)
end
