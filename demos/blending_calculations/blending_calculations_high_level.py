...
# Define fluid
fluid = bpy.Fluid(name="nitrogen", backend="HEOS")
...
p_in, dT_subcooling = 0.6*fluid.critical_point.p, 10
p_out = p_in/5 # fluid.triple_point_liquid.p

props_in = fluid.get_state( bpy.PQ_INPUTS, p_in, 0)
props_in = fluid.get_state(bpy.PT_INPUTS, p_in, props_in["T"] - dT_subcooling)
