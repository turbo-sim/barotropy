...
# Define an array of enthalpies using a subcritical pressure
p = 50e5
...
# Calculate the generalized quality at different pressures and enthalpies
# p = 60e5  # Subcritical case
p = 190e5  # Supercritical case
for h in h_array:
