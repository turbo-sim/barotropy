...
bpy.savefig_in_formats(
    fig, os.path.join(fig_dir, f"supersaturation_along_liquid_isentrope_{fluid.name}")
)
...
bpy.savefig_in_formats(
    fig, os.path.join(fig_dir, f"supersaturation_along_vapor_isentrope_{fluid.name}")
)
