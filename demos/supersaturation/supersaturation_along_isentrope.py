...
for p in p_array:
    ...
    state_equilibrium =  fluid.get_state_equilibrium(
            prop_1="p",
            prop_1_value=p,
            prop_2="s",
            prop_2_value=state_in.s,
            rhoT_guess=rhoT_guess_equilibrium,
            print_convergence=False,
            supersaturation=True,
        )

    state_metastable = fluid.get_state_metastable(
            prop_1="p",
            prop_1_value=p,
            prop_2="s",
            prop_2_value=state_in.s,
    ...
    state_blended = fluid.get_state_blending(
            prop_1="p",
            prop_1_value=p,
            prop_2="s",
            prop_2_value=state_in.s,
...
line1, = ax2.plot(states_equilibrium[x2], states_equilibrium[y2], color=colors[0], linestyle="-", label="Equilibrium properties")
line2, = ax2.plot(states_metastable[x2], states_metastable[y2], color=colors[1], linestyle="-", label="Metastable properties")
line3, = ax2.plot(states_blended[x2], states_blended[y2], color="black", linestyle="-", label="Blended properties")
...
line4, = ax2_secondary.plot(states_equilibrium[x2], states_equilibrium[y2_bis], color=colors[0], linestyle="--",)
line4, = ax2_secondary.plot(states_metastable[x2], states_metastable[y2_bis], color=colors[1], linestyle="--",)
line5, = ax2_secondary.plot(states_blended[x2], states_blended[y2_bis], color="black", linestyle="--")
