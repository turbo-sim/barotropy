...
spinodal_liq, spinodal_vap = bpy.compute_spinodal_line(fluid, N=100, supersaturation=True)
...
bpy.savefig_in_formats(fig, os.path.join(fig_dir, f"supersaturation_along_spinodal_Ts_{fluid.name}"))
...
bpy.savefig_in_formats(fig, os.path.join(fig_dir, f"supersaturation_along_spinodal_ps_{fluid.name}"))
