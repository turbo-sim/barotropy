...
for i = 1:numel(eta_poly)
    ...
    if ismember(var, properties_plot)
        ...
        plot(props.p/1e5, (props.rhomass./props_isentropic.rhomass-1)*100, Color=blended_1, Linewidth = 0.75, DisplayName=label)
    ...
    if ismember(var, properties_plot)
        ...
        plot(props.p/1e5, (props.viscosity./props_isentropic.viscosity-1)*100, Color=blended_1, Linewidth = 0.75, DisplayName=label)
        legend(location='eastoutside', NumColumns=1)
    end
